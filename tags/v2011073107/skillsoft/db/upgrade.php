...
function xmldb_skillsoft_upgrade($oldversion=0) {
    ...
    if ($result && $oldversion < 2011073100) {
    	$result=true;
    }

    if ($result && $oldversion < 2011073101) {
    	$result=true;
    }

    if ($result && $oldversion < 2011073102) {
	    	$result=true;
    }


    if ($result && $oldversion < 2011073103) {
	    	$result=true;
    }

	if ($result && $oldversion < 2011073104) {
	    	$result=true;
    }

	if ($result && $oldversion < 2011073105) {
	    	$result=true;
    }
	...
	if ($result && $oldversion < 2011073107) {
	    	$result=true;
    }
