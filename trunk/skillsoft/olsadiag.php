...
$navlinks = array();
$navlinks[] = array('name' => 'OLSA Diagnostics', 'link' => '');
$navigation = build_navigation($navlinks);

print_header('OLSA Diagnostics', 'OLSA Diagnostics', $navigation);
...
print_heading("Perfoming Basic OLSA Diagnostics");
//echo ('<h1>Perfoming Basic OLSA Diagnostics</h1>');
print_box('This page will perform some basic tests to confirm Moodle Module is able to access SkillSoft OLSA Servers', 'generalbox boxaligncenter boxwidthwide', 'summary');
...
if (!empty($CFG->proxyhost)) {
	...
	print_box('<h2>'.'Moodle Proxy Configuration Details'.'</h2>'.$html, 'generalbox boxaligncenter boxwidthwide', 'summary');
}
...
if ($continue) {
	...
	print_box(testheader($currenttest,'Checking SOAP Extension is loaded').$html, 'generalbox boxaligncenter boxwidthwide', 'summary');
}
...
if ($continue) {
	...
	print_box(testheader($currenttest,'Checking cURL Extension is loaded').$html, 'generalbox boxaligncenter boxwidthwide', 'summary');
}
...
if ($continue) {
	...
	print_box(testheader($currenttest,'Checking OLSA Settings are configured').$html, 'generalbox boxaligncenter boxwidthwide', 'summary');
}
...
if ($continue) {
	...
	print_box(testheader($currenttest,'Is OLSA EndPoint Accessible').$html, 'generalbox boxaligncenter boxwidthwide', 'summary');
}
...
if ($continue) {
	...
	print_box(testheader($currenttest,'Check Time Synchronisation').$html, 'generalbox boxaligncenter boxwidthwide', 'summary');
}
...
if ($continue) {
	...
	$options = array(
		...
		print_box(testheader($currenttest,'Create OLSA SOAP Client').$html, 'generalbox boxaligncenter boxwidthwide', 'summary');
}
...
if ($continue) {
	...
	print_box(testheader($currenttest,'Check OLSA Authentication').$html, 'generalbox boxaligncenter boxwidthwide', 'summary');
}
